...
using NES_Online_Game_Injector.Core;
using NES_Online_Game_AutoInjector.Services;

namespace NES_Online_Game_Injector.GUI
{
    public partial class UIMain : MaterialForm
    {
        private Nvntexpkg Nconvert;
        private Zdrop Zconvert;
        private TGA T;
        ...
        private void ShowTga(int outbox)
        {
            Bitmap BMP = (Bitmap)T;
        ...
        private bool GameCodeCheck_Nformat()
        {
            // The input string.
